...
public:
  ...
  static void
  setTextSize(int x, int y); // ##### Mingw ->Sem efeito (Não disponivel) #####
  ...
  static void
  setTextSizeXP(int x,
                int y); // ##### Mingw ->Sem efeito (Não disponivel) #####
  ...
  drawLine(int x1, int y1, int x2, int y2,
           int cor); // ##### Mingw ->Sem efeito (Não disponivel) #####
  ...
  //   . Se redimensiona a janela
  static void
  drawCircle(int X, int Y, int R, int Pen,
             int Fill); // ##### Mingw ->Sem efeito (Não disponivel) #####
};
